...
@foreach ($data as $members)
    <!-- modal masuk -->
<div class="modal fade" id="modal-cekAnggota-{{$members->idAdmin}}">
    <?php
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Cek anggota tim {{ $members->fullName }}</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
@foreach ($data as $members)
<div class="modal fade" id="modal-tambahAnggota-{{$members->idAdmin}}">
                        <?php
                            $idAdmin = $members->idAdmin
                        ?>
                        <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="{{ url('memberPusdalop/edit/'.$detail->idMember) }}" method="POST">
                                        @csrf
                                        <div class="card-body">
                                            <input type="text" class="form-control" id="idAdmin" placeholder="pusdalop" name="idAdmin" value="{{$noTim}}" required>
